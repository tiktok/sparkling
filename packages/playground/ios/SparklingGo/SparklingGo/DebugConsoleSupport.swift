...
enum DebugConsoleSupport {
    ...
    /// Programmatically open the inspector (Console tab). Used by the legacy
    /// in-app menu entry; with the floating ball installed, users typically
    /// reach the inspector via the ball instead.
