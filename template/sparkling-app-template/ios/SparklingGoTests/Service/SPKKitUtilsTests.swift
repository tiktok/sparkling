...
extension SPKKitUtilsTests {
    fileprivate func expectation(description: String) -> XCTestExpectation {
        return XCTestExpectation(description: description)
    }

    fileprivate func wait(for expectations: [XCTestExpectation], timeout: TimeInterval) {
