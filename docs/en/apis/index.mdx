...
| API | Description |
| --- | --- |
| [AppConfig](/apis/app-config/Interface.AppConfig) | The `app.config.ts` schema — wraps `lynx.config.ts` with Sparkling-specific fields |
...
| [Response codes](/apis/response-codes) | Shared method response code convention |
